<div class="container">
	<div class="row mt-3 justify-content-center">
		<div class="col-md-6">
			...
			<!-- <form action="<?= base_url('mitra/payment') ?>" method="post"> -->
			<form action="" method="post">

				<h1 class="mb-5" style="color: grey;text-align: center">Payment by Mitra</h1>
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<select class="custom-select" name="status_pembayaran" id="status_pembayaran">
								...
								<option value="<?= $kebersihan["status_pembayaran"] ?>"><?= $kebersihan["status_pembayaran"] ?></option>

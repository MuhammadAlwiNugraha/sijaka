		...
		<div class="col-md-6">
			...
			<form action="" method="post">
				...
				<div class="card mt-3 mb-3">
					<div class="card-header" style="background-color: grey;color: white">Data Pemesanan</div>
					<div class="card-body">
						...
						<div class="form-group">
							<input type="hidden" name="status_service" class="form-control" id="status_cucian" value="Tunggu sebentar ya">
						</div>

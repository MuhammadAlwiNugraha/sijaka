				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="alert">
								<input type="checkbox" name="konfirmasi" id="konfirmasi" value="Selesai">
								<label for="konfirmasi">Selesai</label>
							</div>
						</div>

						<div class="form-group">
							<label for="ulasan">Ulasan : </label><br>
							<input type="text" name="ulasan" class="form-control" id="ulasan" value="<?= $kebersihan["ulasan"] ?>">
